...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "sprites",
      "assets/spriteatlas/sprites.png",
      "assets/spriteatlas/sprites.json"
    );
        ...
        this.enemies.forEach(enemy => {
          ...
          if (enemy.dir < 3) {
            enemy.body.setVelocity(
              enemy.dir === 1 ? this.velocity : -this.velocity,
              0
            );
          } else {
            enemy.body.setVelocity(
              0,
              enemy.dir === 3 ? this.velocity : -this.velocity
            );
          }
        });
      }
  ...
  debug() {
    ...
    this.debugGraphics.strokeRect(
      player.body.gridPosition.x * 8,
      player.body.gridPosition.y * 8,
      16,
      16
    );
